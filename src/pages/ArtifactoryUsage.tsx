...
const DASHBOARD_ID = "5k5-g6b-9yk";
const DD_URL = `https://pillar0-siemens.datadoghq.com/dashboard/${DASHBOARD_ID}/artifactory-customer-usage`;
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-heading text-3xl font-bold tracking-tight">
                  Artifactory Customer Usage
                </h1>
                <p className="text-sm text-muted-foreground">
                  Storage, downloads, projects and permissions — live from Datadog (
...
export default ArtifactoryUsage;
