...
import { ShieldCheck, ExternalLink, RefreshCw, AlertCircle } from "lucide-react";

const DASHBOARD_ID = "6e5-nmh-d94";
const DD_URL = `https://pillar0-siemens.datadoghq.com/dashboard/${DASHBOARD_ID}/sonarqube-customer-usage`;
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-heading text-3xl font-bold tracking-tight">
                  SonarQube Customer Usage
                </h1>
                <p className="text-sm text-muted-foreground">
                  Code quality, projects and adoption — live from Datadog (
